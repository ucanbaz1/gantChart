...
def runFileReader(filePath,continerDateGap):  
    ...
    fileFormatName=['commissioning','main-migration-primary','main-migration-secondary','vnfr','stackApi','Ansible_UW','ansible_output']
    # print(fileNames)
    ...
    #        startEndDateExtractor(filePath,str(i))
            ...
            # print(newFile)
            if (str(i).startswith("main") or str(i).startswith("stack") or str(i).startswith("vnfr")):
                list=[]
                ...
                if  len(list)!=0: 
                    ...
                    clockUpdater(file,list,newFile)
                    configure_file=str(i).replace("commissioning.log","configure.log")
